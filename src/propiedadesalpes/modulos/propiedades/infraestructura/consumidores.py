...
from src.propiedadesalpes.modulos.propiedades.infraestructura.schema.v1.eventos import EventoReservaCreada
from src.propiedadesalpes.modulos.propiedades.infraestructura.schema.v1.comandos import ComandoCrearReserva
