import json
from modules.sales.application.queries.get_all_properties import GetAllProperties
import seedwork.presentation.api as api
from modules.sales.application.mappers import MapperPropertyDTOJson
from modules.sales.application.commands.create_property import CreateProperty
...
bp = api.create_blueprint('sales', '/sales')
